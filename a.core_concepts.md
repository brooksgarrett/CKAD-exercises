...
### DONE Create a namespace called 'mynamespace' and a pod with image nginx called nginx on this namespace
...
### DONE Create the pod that was just described using YAML
...
### DONE Create a busybox pod (using kubectl command) that runs the command "env". Run it and see the output
